...
Spica.Event.run(function() { 
	var lightbox = new Lightbox({
		...
		expandimg:'/assets/images/expand.gif',
		shrinkimg:'/assets/images/shrink.gif',
		blankimg:'/assets/images/blank.gif',
		previmg:'/assets/images/prev.gif',
		nextimg:'/assets/images/next.gif',
		closeimg:'/assets/images/close.gif',
		effectimg:'/assets/images/zzoop.gif',
		effectpos:{x:-40,y:-20},
